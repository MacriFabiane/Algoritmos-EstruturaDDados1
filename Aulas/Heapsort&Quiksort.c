...
//mais eficiente no melhor caso(conjunto já ordenado) do que o heapsort(que vair ter o trabalho de reordenar again)
...
// heap pode ser representada por uma arvore binaria, cada nó seguinte deve ser menor que a anterior
// em todos os cenários O(n*log n)
